...
function _buildHTML(meta, obs, habObs, stats, mapImgSrc) {
  ...
  const metaItems = [
   ...
   .map(([l, v]) => `<div class="mi"><div class="ml">${l}</div><div class="mv">${_esc(v)}</div></div>`)
   .join('');
...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    /* Sticky top bar */
    .topbar{position:fixed;top:0;left:0;right:0;background:#111;border-bottom:3px solid #2d6b2d;z-index:999;padding:10px 20px;}
    .topbar-inner{max-width:820px;margin:0 auto;display:flex;justify-content:space-between;align-items:center;gap:16px;}
    .topbar-text{color:#d6d6d6;font-size:0.85rem;font-weight:400;}
    .topbar-hint{display:block;font-size:0.7rem;font-weight:300;color:#666;margin-top:1px;}
    .topbar-btn{background:#2d6b2d;color:#fff;border:1px solid #4caf50;border-radius:6px;padding:9px 22px;font-family:'Oswald',sans-serif;font-size:0.9rem;letter-spacing:0.08em;cursor:pointer;text-transform:uppercase;white-space:nowrap;}
    .topbar-btn:hover{background:#3d8f3d;}
    ...
    /* Section headings */
    h2{font-size:0.85rem;font-weight:600;text-transform:uppercase;letter-spacing:0.1em;color:#2d6b2d;border-bottom:1px solid #cde8cd;padding-bottom:3px;margin:22px 0 8px;}
    ...
    .editable:hover{border-color:#cde8cd;background:#fafffe;}
    .editable:focus{border-color:#2d6b2d;background:#fafffe;outline:2px solid rgba(45,107,45,0.12);}
    ...
    .ptb button:first-of-type{background:#2d6b2d;color:#fff;border:1px solid #2d6b2d;}
    .ptb button:first-of-type:hover{background:#3d8f3d;}
    .ptb button:last-of-type{background:#fff;color:#2d6b2d;border:1px solid #2d6b2d;}
    .ptb button:last-of-type:hover{background:#f0f7f0;}
    ...
    .pbtn{background:#2d6b2d;color:#fff;border:1px solid #4caf50;border-radius:6px;padding:11px 28px;font-family:'Oswald',sans-serif;font-size:1rem;letter-spacing:0.08em;cursor:pointer;text-transform:uppercase;}
...
<div class="page">
  ...
  <!-- 4. Observation Summary (data table — not editable) -->
  ...
  <!-- 6. Observation Locations (map — not editable) -->
  <h2>6. Observation Locations</h2>
  ${mapSection}
